...
plt.xlabel('epoch')
# plt.show()
plt.savefig('../../Outputs/model3_DA_graph_2.png')
plt.close()
model.save('../Models/fungi_classifier_model3_DA_2.h5')
print("saved")
...
plt.savefig('../../Outputs/model3_DA_confusionMatrix_2.png')
plt.close()
# calculate AUC
...
plt.savefig('../../Outputs/model3_DA_roc_2.png')
plt.close()
...
fig.savefig('../../Outputs/model3_DA_display_roc_2.png')
# show the plot
# plt.show()
plt.close(fig)
