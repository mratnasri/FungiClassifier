...
plt.xlabel('epoch')
# plt.show()
plt.savefig('../../Outputs/model2_graph.png')
plt.close()
model.save('../Models/fungi_classifier_model2.h5')
print("saved")
...
plt.savefig('../../Outputs/model2_confusionMatrix.png')
plt.close()
# calculate AUC
...
plt.savefig('../../Outputs/model2_roc.png')
plt.close()
...
fig.savefig('../../Outputs/model2_display_roc.png')
# show the plot
# plt.show()
plt.close(fig)
