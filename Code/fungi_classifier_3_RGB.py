...
plt.xlabel('epoch')
# plt.show()
plt.savefig('../../Outputs/model3_graph.png')
plt.close()
model.save('../Models/fungi_classifier_model3.h5')
print("saved")
...
plt.savefig('../../Outputs/model3_confusionMatrix.png')
plt.close()
# calculate AUC
...
plt.savefig('../../Outputs/model3_roc.png')
plt.close()
...
fig.savefig('../../Outputs/model3_display_roc.png')
# show the plot
# plt.show()
plt.close(fig)
