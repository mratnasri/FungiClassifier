...
plt.xlabel('epoch')
# plt.show()
plt.savefig('../../Outputs/model2_DB3_DA_graph.png')
plt.close()
model.save('../Models/fungi_classifier_model2_DB3_DA.h5')
print("saved")
...
plt.savefig('../../Outputs/model2_DB3_DA_confusionMatrix.png')
plt.show()
plt.close()
# calculate AUC
...
plt.savefig('../../Outputs/model2_DB3_DA_roc.png')
plt.close()
...
fig.savefig('../../Outputs/model2_DB3_DA_display_roc.png')
# show the plot
# plt.show()
plt.close(fig)
