...
plt.xlabel('epoch')
# plt.show()
plt.savefig('../../Outputs/model1_graph_2.png')
plt.close()
model.save('../Models/fungi_classifier_model1_2.h5')
print("saved")
...
plt.savefig('../../Outputs/model1_confusionMatrix_2.png')
plt.close()
# calculate AUC
...
plt.savefig('../../Outputs/model1_roc_2.png')
plt.close()
...
fig.savefig('../../Outputs/model1_display_roc_2.png')
# show the plot
# plt.show()
plt.close(fig)
