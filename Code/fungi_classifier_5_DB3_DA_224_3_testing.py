...
plt.xlabel('epoch')
# plt.show()
plt.savefig('../../Outputs/model5_DB3_DA_graph_6.png')
plt.close()
model.save('../Models/fungi_classifier_model5_DB3_DA_6.h5')
print("saved")'''
...
plt.savefig('../../Outputs/model5_DB3_DA_3_testing_confusionMatrix.png')
plt.show()
plt.close()
# calculate AUC
...
plt.savefig('../../Outputs/model5_DB3_DA_3_testing_roc.png')
plt.close()
...
fig.savefig('../../Outputs/model5_DB3_DA_3_testing_display_roc.png')
# show the plot
# plt.show()
plt.close(fig)
print("done")
