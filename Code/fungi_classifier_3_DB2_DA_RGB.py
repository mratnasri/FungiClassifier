...
plt.xlabel('epoch')
# plt.show()
plt.savefig('../../Outputs/model3_DB2_DA_graph.png')
plt.close()
model.save('../Models/fungi_classifier_model3_DB2_DA.h5')
print("saved")
...
disp.plot()
plt.show()
plt.savefig('../../Outputs/model3_DB2_DA_confusionMatrix_saved.png')
plt.close()
# calculate AUC
...
plt.savefig('../../Outputs/model3_DB2_DA_roc.png')
plt.close()
...
fig.savefig('../../Outputs/model3_DB2_DA_display_roc.png')
# show the plot
# plt.show()
plt.close(fig)
