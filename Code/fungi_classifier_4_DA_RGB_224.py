...
gram_img_DA_dir=  '../../Gram Stain Images_Crops_ver3_DA'
categories_n = 3
...
plt.xlabel('epoch')
# plt.show()
plt.savefig('../../Outputs/model4_DA_graph_2.png')
plt.close()
model.save('../Models/fungi_classifier_model4_DA_2.h5')
print("saved")
...
plt.savefig('../../Outputs/model4_DA_confusionMatrix_2.png')
plt.close()
# calculate AUC
...
plt.savefig('../../Outputs/model4_DA_roc_2.png')
plt.close()
...
fig.savefig('../../Outputs/model4_DA_display_roc_2.png')
# show the plot
# plt.show()
plt.close(fig)
