...
plt.xlabel('epoch')
# plt.show()
plt.savefig('../../Outputs/model4_graph.png')
plt.close()
model.save('../Models/fungi_classifier_model4.h5')
print("saved")
...
plt.savefig('../../Outputs/model4_confusionMatrix.png')
plt.close()
# calculate AUC
...
plt.savefig('../../Outputs/model4_roc.png')
plt.close()
...
fig.savefig('../../Outputs/model4_display_roc.png')
# show the plot
# plt.show()
plt.close(fig)
