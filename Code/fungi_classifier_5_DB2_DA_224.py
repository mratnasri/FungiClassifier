...
gram_img_DA_dir=  '../../Gram Stain Images_ver2_Crops_ver2_DA'
categories_n = 3
...
plt.xlabel('epoch')
# plt.show()
plt.savefig('../../Outputs/model5_DB2_DA_graph_2.png')
plt.close()
model.save('../Models/fungi_classifier_model5_DB2_DA_2.h5')
print("saved")
...
disp.plot()
plt.show()
plt.savefig('../../Outputs/model5_DB2_DA_confusionMatrix_2.png')
plt.close()
# calculate AUC
...
plt.savefig('../../Outputs/model5_DB2_DA_roc_2.png')
plt.close()
...
fig.savefig('../../Outputs/model5_DB2_DA_display_roc_2.png')
# show the plot
# plt.show()
plt.close(fig)
