...
gram_img_dir = '../../Gram Stain Images_Crops_ver3'
categories_n = 3
...
def model_config(input_shape):
    ...
    model = keras.applications.vgg16.VGG16(
        input_shape=input_shape, include_top=True, weights='imagenet', classes= categories_n)
...
plt.xlabel('epoch')
# plt.show()
plt.savefig('../../Outputs/model5_graph.png')
plt.close()
model.save('../Models/fungi_classifier_model5.h5')
print("saved")
...
plt.savefig('../../Outputs/model5_confusionMatrix.png')
plt.close()
# calculate AUC
...
plt.savefig('../../Outputs/model5_roc.png')
plt.close()
...
fig.savefig('../../Outputs/model5_display_roc.png')
# show the plot
# plt.show()
plt.close(fig)
